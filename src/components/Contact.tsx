...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 px-4 md:px-8 bg-gradient-to-b from-black via-blue-900/10 to-black">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-400 text-lg mb-16 max-w-3xl mx-auto">
          Ready to make your event unforgettable? Get in touch and let's create magic together
        </p>

        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {/* Contact Info */}
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-gray-900 to-black p-6 rounded-2xl border border-gray-800 hover:border-neon-purple transition-all duration-300">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black p-6 rounded-2xl border border-gray-800 hover:border-neon-blue transition-all duration-300">
              <div className="flex items-center gap-4">
                <div className="bg-neon-blue/20 p-4 rounded-full">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black p-6 rounded-2xl border border-gray-800 hover:border-neon-pink transition-all duration-300">
              <div className="flex items-center gap-4">
                <div className="bg-neon-pink/20 p-4 rounded-full">
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 bg-gradient-to-br from-red-500/20 to-pink-500/20 p-4 rounded-xl border border-red-500/30 hover:border-red-500 transition-all duration-300 hover:scale-105"
                >
            ...
            <div className="mt-8 space-y-4">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-5 rounded-2xl text-lg font-semibold hover:opacity-90 transition-all duration-300 hover:scale-105 box-glow-purple"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center gap-3 bg-green-500 text-white px-8 py-5 rounded-2xl text-lg font-semibold hover:bg-green-600 transition-all duration-300 hover:scale-105 box-glow-green"
              >
